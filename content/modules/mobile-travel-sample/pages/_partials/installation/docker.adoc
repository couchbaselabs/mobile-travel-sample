...
[source,bash]
----
$ docker pull couchbase/sync-gateway:2.6.0-enterprise
----
...
docker run -p 4984-4985:4984-4985 --network workshop --name sync-gateway -d -v %cd%/sync-gateway-config-travelsample.json:/etc/sync_gateway/sync_gateway.json couchbase/sync-gateway:2.6.0-enterprise -adminInterface :4985 /etc/sync_gateway/sync_gateway.json
----
...
$ docker run -p 4984-4985:4984-4985 --network workshop --name sync-gateway -d -v `pwd`/sync-gateway-config-travelsample.json:/etc/sync_gateway/sync_gateway.json couchbase/sync-gateway:2.6.0-enterprise -adminInterface :4985 /etc/sync_gateway/sync_gateway.json
----
...
[source,json]
----
{"couchdb":"Welcome","vendor":{"name":"Couchbase Sync Gateway","version":"2.6"},"version":"Couchbase Sync Gateway/2.6.0(271;bf3ddf6) EE"}
----
