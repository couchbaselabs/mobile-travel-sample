...
Before you begin this lesson, confirm that you have Sync Gateway up and running by following the instructions in the xref::{param-language}/installation/sync-gateway-2.0.adoc[Sync Gateway installation] section.
