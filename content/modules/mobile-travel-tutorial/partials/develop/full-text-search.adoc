...
{cbl-te} footnote:[From 2.0] supports Full Text Search (FTS).
...
[source, {param-language}, subs="macros+, attributes+"]
----

include::{param-module}/_partials/snippets[tags='createdatabaseindexes']
