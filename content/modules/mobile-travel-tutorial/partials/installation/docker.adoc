...
ifndef::cbs-version-m1[:cbs-version-m1: 7.1.1]
...
[source,bash, subs="attributes+, macros+"]
----
docker pull couchbase/server-arm:{cbs-version-m1}
----
Others::
+
[source,bash, subs="attributes+, macros+"]
...
[source,bash, subs="attributes+, macros+"]
----
docker run -d --name cb-server --network workshop -p 8091-8094:8091-8094 -p 11210:11210 couchbase/server-arm:{cbs-version-m1}
----
Others::
+
[source,bash, subs="attributes+, macros+"]
