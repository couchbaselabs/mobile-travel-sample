...
In this lesson, you will install and launch Couchbase Server.

If there is a later version available, you can download it as well bearing in mind that the instructions have been validated with a certain version.
