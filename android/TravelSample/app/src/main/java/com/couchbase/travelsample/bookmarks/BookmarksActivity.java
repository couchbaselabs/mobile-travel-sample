...
public class BookmarksActivity extends AppCompatActivity implements BookmarksContract.View {
    ...
    @Override
    public void showBookmarks(final List<Map<String, Object>> bookmarks) {
        final ResultAdapter adapter = new ResultAdapter(bookmarks, "name", "address");
        adapter.setOnItemClickListener(new ResultAdapter.OnItemListener() {
            ...
            public void OnSwipe(int position) {
                Map<String, Object> item = bookmarks.get(position);
                if (bookmarks.contains(item)) {
                    bookmarks.remove(position);
                    adapter.notifyItemRemoved(position);
                }
                mActionListener.removeBookmark(item);
            }
        });
    ...
    private void setUpItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            private void init() {
                ...
                xMark = ContextCompat.getDrawable(BookmarksActivity.this, R.drawable.ic_clear_24dp);
                xMark.setColorFilter(Color.WHITE, PorterDuff.Mode.SRC_ATOP);
                xMarkMargin = (int) BookmarksActivity.this.getResources().getDimension(R.dimen.ic_clear_margin);
                initiated = true;
            }
            ...
            public int getSwipeDirs(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
                ...
                ResultAdapter testAdapter = (ResultAdapter)recyclerView.getAdapter();
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                ResultAdapter adapter = (ResultAdapter)mRecyclerView.getAdapter();
